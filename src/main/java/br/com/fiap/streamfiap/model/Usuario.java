...
public class Usuario {
    ...
    public Usuario(String nome, int idade, double creditos, Long id) {
        this.setNome(nome);
        this.setIdade(idade);
    ...
    public Usuario alugar(Conteudo conteudo) throws ClassificacaoIndicativaException {
        // conteúdos indisponíveis não podem ser alogados
        if (conteudo.isDisponivel()) {
            throw new ConteudoIndisponivelException(conteudo.getTitulo() + "está indisponível!");
        }
